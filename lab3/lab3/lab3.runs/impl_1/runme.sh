...
HD_PWD='C:/Users/Bobby School/Desktop/Vivado Projects/Lab3/lab3/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPSmachine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MIPSmachine.tcl -notrace

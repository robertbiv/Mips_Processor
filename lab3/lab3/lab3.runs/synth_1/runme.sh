...
HD_PWD='C:/Users/Bobby School/Desktop/Vivado Projects/Lab3/lab3/lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPSmachine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MIPSmachine.tcl

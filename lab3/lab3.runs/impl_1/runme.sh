...
HD_PWD='C:/Users/Bobby School/Desktop/Vivado Projects/FinalProject/lab3/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ConnectionBoard.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ConnectionBoard.tcl -notrace
